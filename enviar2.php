...
// Mudar Aqui o e-mail
$email_envio = 'contato@cardiologiabrasilia.med.br'; // E-mail do site (ex: contato@seusite.com)
$email_pass = 'CcSr5324'; // Senha do e-mail

$site_name = 'Cardiologia-Brasilia'; // Nome do Site
$site_url = 'www.cardiologiabrasilia.med.br'; // URL do Site
...
try {
  ...
  $mail->SMTPDebug = 1; // Tire do comentário para debugar
  $mail->isSMTP();
  $mail->Host = $host_smtp;
  $mail->SMTPAuth = true;
